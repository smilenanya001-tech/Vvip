...
bot_token = '6878046471:AAGEwxX9NIV6CRF1_xpqGwHGaEKREPRKXPM'  # Replace with your bot token
...
ADMIN_ID = 5826548994  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @KINGMOHITYT: {ADMIN_ID}")
